...
foreach ($accessLevels as $level) {
    if ($level === '*') {
        $sqlClassName = "SELECT class_name FROM classes ORDER BY class_name ASC";
    } else {
        $sqlClassName = "SELECT class_name FROM classes WHERE id = $level ORDER BY class_name ASC";
    }
...
// Henter studentdata basert på de gitte klassene, sortert etter klassenavn
$sqlStudents = "SELECT * FROM students WHERE class IN ('$classNamesString') ORDER BY class";
    ...
    <div class="container">
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($resultStudents)): ?>
                            <tr>
                                ...
                                <p style="margin:0;"><td class="<?php echo getFravaerClass($row["absence"]); ?>"><?php echo $row["absence"] ?></td></p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col d-flex justify-content-start">
                            <a href="create-absence.php" class="btn btn-dark mb-3 mx-1">Legg til elev</a>
                            <button type="submit" name="merk-til-stede" class="btn btn-dark mb-3 mx-1">Merk alle til stede</button>
                            <button type="submit" name="nullstill-fravaer" class="btn btn-dark mb-3 mx-1">Nullstill fravær</button>
                        </div>
                        <div class="col d-flex justify-content-end">
                            <a href="download.php" class="btn btn-dark mb-3 mx-1" download><i class="fa fa-download"></i> Last ned som XLS</a>
                        </div>
                    </div>
                </div>
            </form>
        <?php else: ?>
            ...
            <form method="POST">
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="<?php echo getFravaerClass($row["absence"]); ?> rounded text-center p-1"><?php echo $row["absence"] ?></p>
                ...
                <button type="submit" name="merk-til-stede" class="btn btn-dark mb-3 mx-1">Merk alle til stede</button>
                <button type="submit" name="nullstill-fravaer" class="btn btn-dark mb-3 mx-1">Nullstill fravær</button>
                <a href="download.php" class="btn btn-dark mb-3" download><i class="fa fa-download mx-1"></i> Last ned som XLS</a>
            </form>
        <?php endif; ?>
