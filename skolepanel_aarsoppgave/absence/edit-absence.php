            ...
            <form action="" method="post" style="width:50vw; min-width:300px;">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="class">
                        <?php
                        // Loop gjennom alle klassenavnene som brukeren har tilgang til
                        foreach ($classNames as $className) {
                            echo '<option value="' . $className . '"';
                            // Hvis klassenavn samsvarer med klassen til den nåværende eleven, merk den som valgt
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select" id="absenceSelect" name="absence" onchange="toggleExtraOptions()">
                        ...
                        <option value="Til stede"
                            <?php echo ($row["absence"] == 'Til stede') ? "selected" : ""; ?>>Til stede</option>
                        <option value="Fraværende"
                            <?php echo ($row["absence"] == 'Fraværende') ? "selected" : ""; ?>>Fraværende</option>
                    </select>
                </div>

                <div id="extraOptions" style="display: none;">
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="absence_type" id="documented"
                            value="Dokumentert">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="absence_type" id="undocumented"
                            value="Udokumentert" <?php echo ($row["absence"] == 'Udokumentert') ? "checked" : ""; ?>>
                ...
                <div id="commentSection" style="display: none;">
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" name="comment" id="comment" rows="3"
                            maxlength="200"><?php echo $row['comment']; ?></textarea>
